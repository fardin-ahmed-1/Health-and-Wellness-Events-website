  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        <div data-aos="fade-right" className="grid grid-cols-1 gap-8  lg:grid-cols-2">
          ...
          <div className="p-4 rounded-lg bg-blue-50">
            ...
            <p className="mt-2 text-xl text-secondary">hello@merakiui.com</p>
          </div>

          <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
            <span className="inline-block p-3 text-secondary rounded-lg bg-blue-100/80 dark:bg-gray-700">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
            ...
            <p className="mt-2 text-xl text-secondary dark:text-blue-400">Start new chat</p>
          </div>
          ...
          <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
            ...
            <p className="mt-2 text-xl text-secondary dark:text-blue-400"> Collingwood VIC 3066 AU</p>
          </div>
          ...
          <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
            ...
            <p className="mt-2 text-xl text-secondary dark:text-blue-400">+1 (555) 000-0000</p>
          </div>
        </div>
          
          
          <div data-aos="fade-left" className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
              ...
              <button onClick={formSubmite} className="w-full px-6 py-3 mt-4 text-xl font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-secondary">
                Send message
              </button>
